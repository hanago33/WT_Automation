...
with UIPath(u"Global Mapper v22.1 (b082421) [64-bit] [+OTF] [+LIDAR] - 中文注册版||Window"):
	...
	with UIPath(u"配置 - 投影||Window"):
		...
		send_keys("{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}""{VK_CONTROL down}o""{VK_CONTROL up}")
