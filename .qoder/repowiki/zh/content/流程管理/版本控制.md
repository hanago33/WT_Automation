...
- [generate_project_ppt.py](file://docs/06-论文与汇报\生成脚本\generate_project_ppt.py)
- [generate_project_ppt_com.ps1](file://docs/06-论文与汇报\生成脚本\generate_project_ppt_com.ps1)
</cite>
...
- 文档生成脚本：docs/06-论文与汇报\生成脚本\generate_project_ppt.py、docs/06-论文与汇报\生成脚本\generate_project_ppt_com.ps1（可用于生成包含版本信息的演示材料）
